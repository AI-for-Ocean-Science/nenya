...
# Example 1: Generate dataset with n=2 (common for natural images)
...
main(
    ...
    seed=1234,
    size=64,
    output_file='power_law_n2.0_64x64.h5',
    verify=True  # This will verify the power spectrum
)

print("\n" + "="*60 + "\n")

# Example 2: Generate dataset with n=3 (steeper spectrum, smoother images)
...
main(
    ...
    seed=1234,
    size=64,
    output_file='power_law_n3.0_64x64.h5',
    verify=False  # Skip verification for faster generation
)
